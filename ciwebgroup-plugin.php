...
class CIWebGroupPlugin
{
	...
	function createHTML($content)
	{
		...
		$html = '<p class="txt-center" id="social-icon-links">' . $fico . '<span>' . $tico . '</span>
			<span>' . $lico . '</span>
		</p>';
